...
def post_comment_like():
    ...
    try:
        ...
        #posts.update({'permalink':permalink, 'comments': ordinal}, {'$inc':{'num_likes':1}}, upsert=True, manipulate=False, safe=True)
        if 'num_likes' in post['comments'][ordinal]:
            post['comments'][ordinal]['num_likes'] = post['comments'][ordinal]['num_likes'] + 1
        else:
            post['comments'][ordinal]['num_likes'] = 1
        
        print post['comments'][ordinal]['num_likes']
        posts.save(post)
